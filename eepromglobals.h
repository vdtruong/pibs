...
// Sensor types array initial, header in front.
unsigned char sens_type_cntr =  0;	// Counter for sens_type_arry.
unsigned char sens_type_arry[] = "\x09\x00\x00\x00\x00\x00\x00\x00\x00";
unsigned char new_dat_flg = 0;		// Indicate new dat is available.
